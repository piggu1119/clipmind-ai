...
export const PRICING_PLANS = [
  {
    ...
    features: [
      ...
      'Basic AI Hook quality',
      'Standard subtitle formats',
      'Clipmind watermark in previews',
  ...
  },
  {
    ...
    features: [
      ...
      'Advanced GPT-4 powered Hook engine',
      'Premium subtitle presets (Anime & Sports)',
      'NO watermarks',
      'Priority clippers queue',
      'Streaks tracker multiplier',
      'Creator presets saving',
    ],
    cta: 'Upgrade to Pro',
    popular: true,
  ...
  },
  {
    ...
    price: '$29',
    period: 'month',
    description: 'Designed for clippers teams and editing networks.',
    features: [
      'Everything in Pro tier',
      'Up to 5 team workspace accounts',
      'Bulk processing (up to 10 URLs)',
      'Export directly to Adobe Premiere XML',
      'API access endpoint',
      'Premium customer manager support',
      'Custom watermark uploads',
    ],
    cta: 'Get Agency Access',
    popular: false,
    gradient: 'from-cyan-950/60 to-slate-900/60 border-cyan-500/50',
  }
];
